...
module.exports = class Requests {
  ...
  /**
     ...
     */
  async login(client_id = this.client_id, scopes = this.scopes) {
    ...
    await page.type(emailPath, this.login_cred.email).catch(() => {
  ...
  /**
     ...
     */
  async getOAuth(client_secret = this.client_secret, auth_code = this.auth_code) {
