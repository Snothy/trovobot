...
module.exports = async function login(login_credentials, client_id, headless, viewport) {
  /**
   * 
   */
...
module.exports = async function getOAuth(auth_code, client_id, client_secret) {
  /**
   * 
   */
...
module.exports = async function getChannelId(client_id, listOfUsernames) {
  /**
   * 
   */
...
module.exports = async function getChannelChatToken(client_id, channel_id) {
  /**
   * 
  */
...
module.exports = async function getOwnChatToken(client_id, OAuth) {
  /**
   * 
   */
...
module.exports = async function sendMessage(client_id, OAuth, message) {
  /**
   * 
   */
